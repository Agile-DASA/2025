...
170		continue
		...
		If(GValue.LT.DistMin*1.08)then
...
c#		If(GValue.LT.DistMin*1.06)then
c#		Write(FileNum+2,*)  '[',Area(1,aint),',',Area(2,bint),']', 0
c#		Else 
c#      	Write(FileNum+2,*)'[',Area(1,aint),',',Area(2,bint),']',1
c#		End if
		
c#		If(GValue.LT.DistMin*1.)then
c#		Write(FileNum+3,*) '[',Area(1,aint),',',Area(2,bint),']', 0
c#		Else 
c#    	Write(FileNum+3,*)'[',Area(1,aint),',',Area(2,bint),']',1
c#		End if
